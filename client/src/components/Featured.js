...
export const Featured = props => {
  ...
  return (
    <div className="box alt container">
      <Link activeClass="active" to="searchResults" smooth={true} offset={-70} duration={1000}>
        <section
        ...
        >
          ...
          <div className="content">
            ...
            <p>
              From the first performance on the steps of City Hall in 1978, The San Francisco Gay Men's Chorus has been
              a beacon of hope to the gay community both locally and abroad.
            </p>
          </div>
        </section>
      </Link>
      <Link activeClass="active" to="searchResults" smooth={true} offset={-70} duration={1000}>
        ...
        >
          ...
          <div className="content">
            <h3>The 1980s</h3>
            <p>
              A short blurb about what the chorus went through in the 80s. Click here to see archival pieces from this
              era.
            </p>
          </div>
        </section>
      ...
      <Link activeClass="active" to="searchResults" smooth={true} offset={-70} duration={1000}>
        ...
        >
          ...
          <div className="content">
            <h3>The 1990s</h3>
            <p>
              A short blurb about what the chorus went through in the 90s. Click here to see archival pieces from this
              era.
            </p>
          </div>
        </section>
      ...
      <Link activeClass="active" to="searchResults" smooth={true} offset={-70} duration={1000}>
        ...
        >
          ...
          <div className="content">
            <h3>The 2000s</h3>
            <p>
              A short blurb about what the chorus went through in the 00s. Click here to see archival pieces from this
              era.
            </p>
          </div>
        </section>
